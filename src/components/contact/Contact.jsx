...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("https://krj307-2.pl/server/mailer", {
        method: "POST",
    ...
    <section id="kontakt">
      <div className="relative">
        <div className="grid grid-cols-12 w-full h-full absolute -z-10">
          <div className="md:col-span-6 bg-[#FAF2E9]"></div>
          <div className="md:col-span-6 bg-[#292929]"></div>
        </div>
          ...
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-9 bg-[#292929] flex flex-col p-6 md:py-24 md:pl-24">
              ...
              <form onSubmit={handleSubmit} className="w-full md:w-2/3">
                ...
                />
                <label htmlFor="privacyAccepted" className="text-white pl-3">
                  Wyrażam zgodę na przetwarzanie moich danych osobowych oraz potwierdzam, że zapoznałem się z treścią <Link to={"https://krj307-2.pl/upload/krj307-2.pdf"} target="_blank" className="underline hover:no-underline">Polityki prywatności</Link>
                </label>
                ...
                <div className="flex justify-end w-full mt-6">
                  <button type="submit" className="flex-1 md:max-w-[50%] bg-[#C2A992] text-white py-2 px-6 cursor-pointer font-poppins" disabled={isSubmitting}>
